...
import {
  ...
  IconButton, AppBar, Toolbar, Divider, Button,
} from '@mui/material';
...
const navItems = [
  ...
  { label: 'Company Profile', href: '/dashboard/company',icon: <BusinessIcon /> },
];
    ...
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ p: 2 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1.5 }}>
          <Avatar sx={{
            width: 36, height: 36,
            background: '#003366', fontSize: '0.85rem',
          }}>
    ...
    <Box sx={{ display: 'flex', minHeight: '100vh' }}>
      ...
      >
        <Toolbar>
          ...
          <Typography sx={{
            fontFamily: '"Playfair Display", serif',
            fontWeight: 700, fontSize: '1rem', ml: 1,
          }}>
            CDC Portal
          </Typography>
        </Toolbar>
